...
<h2 class ="heading type-header text-elevated color-dark-blue">a new deepwater frontier</h2>                                                                                    <div class="description centered type-body text-reduced width-600">
...
<a href="what-we-do/energy/oil-and-natural-gas/assets/anchor.html" class="cta-link type-cta text-base" target="" >                                                    <span class="cta-glyphicon">
                            ...
                            <li class="list-item ">
                                <div class="text-container text-center width-1000 background-color-dark-blue color-opacity-50">
                                    <div class="text-container-inner centered">
<h2 class ="heading type-header text-elevated color-dark-blue">2Q 2024 earnings</h2>                                                                                    <div class="description centered type-body text-reduced width-600">
...
<a href="investors.html" class="cta-link type-cta text-base" target="" title="visit our investor page to learn more" >                                                    <span class="cta-glyphicon">
                            ...
                            <li class="list-item ">
                                <div class="text-container text-center width-1000 background-color-dark-blue color-opacity-50">
                                    <div class="text-container-inner centered">
<h2 class ="heading type-header text-elevated color-dark-blue">moving towards a lower <nobr>carbon future</nobr></h2>                                                                                    <div class="description centered type-body text-reduced width-600">
...
<a href="sustainability/environment/energy-transition.html" class="cta-link type-cta text-base" target="" >                                                    <span class="cta-glyphicon">
                            ...
                            <li class="list-item ">
                                <div class="text-container text-center width-1000 background-color-dark-purple color-opacity-50">
                                    <div class="text-container-inner centered">
<h2 class ="heading type-header text-elevated color-dark-blue">seeking solutions using <nobr>human ingenuity</nobr></h2>                                                                                    <div class="description centered type-body text-reduced width-600">
...
<a href="what-we-do/energy/new-energies.html" class="cta-link type-cta text-base" target="" >                                                    <span class="cta-glyphicon">
                            ...
                            <li class="list-item ">
                                <div class="text-container text-center width-1000 background-color-dark-teal color-opacity-50">
                                    <div class="text-container-inner centered">
<h2 class ="heading type-header text-elevated color-dark-blue">evolving energy for today <nobr>and tomorrow</nobr></h2>                                                                                    <div class="description centered type-body text-reduced width-600">
...
<h3 class ="sub-heading text-left type-display text-reduced text-super color-medium-green color-important">carbon capture and storage</h3>                                <div class="description type-body text-base">
...
<a href="newsroom/subscribe.html" class="link signup-button theme-bg-color" target="" >sign up now</a>        </div>
        </div>
    </div>
...
<style>
#mod_200e951a div#splide01-track { margin-bottom: 0; }
...
#mod_f92a6c4a { background-position: 80% center !important; }
</style>
...
<a href="https://www.linkedin.com/company/chevron" class="social-link" rel="noopener noreferrer" target="_blank" >                                        <img class="social-link-icon" src="-/media/chevron/Footer/linkedin.svg" alt="linkedin" />
    ...
    <div class="copyright-row centered width-1200">
        ...
        <div class="copyright type-body text-caption"><p>&copy; 2001 &ndash; 2024 Chevron Corporation. <span class="d-block d-md-inline">All rights reserved.</span></p></div>
    </div>
</footer>    </div>
...
<!-- s: 003L7 @ 8/29/2024 5:51:21 PM UTC -->

</body>

<!-- Mirrored from www.chevron.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 19:54:49 GMT -->
</html>
